...
selbst behandelt werden, ist die Nutzung am effizientesten. Denn werden
keine Optionen beim Aufruf der Methode angegeben, kehrt parameters()
sofort zurück.
...
Argumente der Methode behandelt. Dies ist vor allem nützlich, wenn
die Methode eine variable Anzahl an Argumenten hat. Diese werden
von parameters() aus der Parameterliste "herausgefischt".
