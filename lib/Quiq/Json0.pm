...
Quiq::Json0 - Übersetze JSON-Code
...
=item indentArrayElements => $bool (Default: 0)

Rücke Array-Elemente ein.

=item indentHashElements => $bool (Default: 1)

Rücke Hash-Elemente ein.
