...
Referenz auf Array von Arrays von Z-Werten. Dies sind verschiedene
Sätze von Markerfarben, also verschiedene Listen von Farbwerten.
Zu jedem Satz von Markerfarben muss ein Name vereinbart werden,
siehe Attribut B<zNames>.

=item zNames => \@names

Liste der Namen der Z-Wert-Sätze.
