...
Schlieﬂe Cursor. Die Methode liefert keinen Wert zur¸ck.
...
=head3 isSelect() - Pr¸fe, ob Cursor Datens‰tze liefert
...
=head3 time() - Liefere Dauer seit Start der Statement-Ausf¸hrung
...
Datenbank aus. Die Anzahl der Werte muﬂ ein Vielfaches der Anzahl der
Bind-Variablen sein.
...
Tabelle. Ist der Parameter $autoCloase angegeben und "wahr" schlieﬂe
