...
Das Objekt kann aus verschiedenen externen Repr‰sentationen
instantiiert werden und kann seinerseits verschiedene externe
Repr‰sentationen liefern. Ferner kann die Helligkeit der Farbe
ermittelt werden, was f¸r eine Fontauswahl n¸tzlich sein kann.
Auﬂerdem kann der Farbe ein Name zugewiesen werden.
