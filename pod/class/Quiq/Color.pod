...
Ein Objekt der Klasse repr‰sentiert eine Farbe des RGB-Farbraums,
also ein Tripel (R, G, B). Das Objekt kann aus verschiedenen
externen Repr‰sentationen instantiiert werden und seinerseits
verschiedene externe Repr‰sentationen liefern. Ferner kann die
Helligkeit der Farbe ermittelt werden, was f¸r eine Fontauswahl
n¸tzlich sein kann. Auﬂerdem kann der Farbe ein Name zugewiesen
werden.
...
255 (weiﬂ). Bei einem Wert < 128 ist die Farbe dunkel, andernfalls hell.
...
Das Farbobjekt besitzt zun‰chst keinen Namen. Mit dieser Methode
...
=head2 Externe Repr‰sentationen
