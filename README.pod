...
Klassen, die ich in Projekten (nur Unix/Linux) nutze. Sie
...
L<Quiq::Sql::Composer|https://github.com/s31tz/Quiq/tree/master/pod/class/Quiq/Sql/Composer.pod> - Klasse zum Erzeugen von SQL
